-- scipt taken from https://github.com/olimorris/dotfiles/blob/main/.config/hammerspoon/zoom-killer.lua
...
local function kill_zoom(app_name, event_type, app)
	...
	then
		...
		app:kill()
		-- text add to console for debugging
		print("Zoom killed - mic surveillance ended")
	end
end
